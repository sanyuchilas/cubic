...
export function FisrtLevel() {
  ...
  return (
    <group dispose={null}>
      ...
      <mesh geometry={nodes['3_export_wires'].geometry} material={materials.wires} position={[4.16, 1.72, -0.03]} rotation={[1.5, 0, -Math.PI / 2]} />
      ...
      <mesh geometry={nodes['2_contramotor'].geometry} castShadow material={materials.boxes} position={[-0.5, 0.59, -0.5]} rotation={[Math.PI, Math.PI / 4, -1.2]} />
      ...
      <group rotation={[0, 0, -Math.PI / 2]} position={[-1.12, -1.12, 0]}>
        ...
        <group position={[-1.5, 0.59, 1.5]} rotation={[0, Math.PI / 4, 1.94]}>
      ...
      <mesh geometry={nodes.room_2.geometry} material={materials.window_1} />
      <mesh geometry={nodes.room_3.geometry} material={materials.window_2} />
