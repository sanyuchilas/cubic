...
const HelpPage = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <p>
        Объект C-16-O. Занимался разработкой ЧВП в компании TimeStamp, впоследствии был уволен и помещен во временную систему T-16-G, в которой система охлаждения компьютера <b>срабатывает моментально</b> с последующим ослаблением эффекта и которая состоит из совокупности двух небольших ЧВП, созданных другим сотрудником по приказу менеджера компании, с <b>десятиминутным</b> жизненным циклом. C-16-O связался с вами и дал доступ к управлению T-16-G через внутренний компьютер. Пытался сбежать самостоятельно, но ничего не вышло...
      </p>
